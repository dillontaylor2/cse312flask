    ...
    if "authtoken" in request.cookies:
        ...
        if user == "None":
            ...
            response = make_response(
                render_template("index.html", dates=matches, user="None", cheesebannerlink=cheesebannerlink,
                                colorchangegen=colorChange))
            ...
            response = make_response(
                render_template("index.html", dates=matches, user=user["username"], cheesebannerlink=cheesebannerlink,
                                colorchangegen=colorChange))
            response.headers["Content-Type"] = "text/html"
        ...
        if password == confirmed_password:
            ...
            user_data.insert_one(
                {"username": username, "password": fin_pass, "cheese": cheese, "authtoken": "", "liked_user": [],
                 "match": [], "age": age, "catchphrase": catch_p})
